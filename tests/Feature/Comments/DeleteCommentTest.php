...
class DeleteCommentTest extends TestCase {
    ...
    /** @test */
    public function show_delete_comment_livewire_component_when_user_has_authorization() {
    ...
    /** @test */
    public function deleting_a_comment_dont_show_on_menu_when_user_has_no_authorization() {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
