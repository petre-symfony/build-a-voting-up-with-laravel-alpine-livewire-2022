        ...
        <form wire:submit.prevent="setStatus" action="" class="space-y-4 px-4 py-6">
            <div class="space-y-2">
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" class="bg-gray-200 text-black" type="radio" checked="" name="radio-direct" value="1">
                        <span class="ml-2">Open</span>
                    </label>
                </div>
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" class="bg-gray-200 text-purple" type="radio" name="radio-direct" value="2">
                        <span class="ml-2">Considering</span>
                    </label>
                </div>
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" class="bg-gray-200 text-yellow" type="radio" name="radio-direct" value="3">
            ...
            <div>
                <label class="font-normal inline-flex items-center">
                    <input wire:model="notifyAllVoters" class="rounded bg-gray-200" type="checkbox" name="notify_voters">
